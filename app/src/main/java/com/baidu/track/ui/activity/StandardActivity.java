...
public class StandardActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ruleTool = new RuleTool(mContext);

        recycleAdapter = new ListAdapter(mContext, ruleTool.getCategorylist());
        ...
        recycleAdapter.setItemClickListener(new onItemClickListener() {
            ...
            public void itemClick(int position) {
                            ...
                            bundle.putString("category", "治理标准");
                            bundle.putString("legal", ruleTool.getCategorylist().get(position));
                            bundle.putString("standardcontent", ruleTool.getStandardlist().get(position));
