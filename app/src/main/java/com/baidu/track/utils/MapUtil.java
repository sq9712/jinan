...
public class MapUtil {
    ...
    public void drawHistoryTrack(List<LatLng> points, boolean staticLine, float direction) {
        ...
        // 绘制纹理PolyLine
        BitmapDescriptor mGreenTexture = BitmapDescriptorFactory.fromAsset("Icon_road_blue_arrow.png");
        PolylineOptions polylineOptions = new PolylineOptions().points(points).width(12).customTexture(mGreenTexture)
                .dottedLine(true);
